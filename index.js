...
const lessonDirs = [
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-0-structure"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-1"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-2"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-3"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-4"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-5"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-6"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-7"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-8"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-9"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-10"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-11"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-12"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-13"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-14"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "js-async-course", "lesson-15"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "intro"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-1"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-2"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-3"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-4"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-5"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-6"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-7"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-8"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-9"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-10"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-11"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-12"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-13"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-14"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-15"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-16"),
	path.join(__dirname, "..", "udemy_cloudfront_course", "src", "aws-auth-course", "lesson-17"),
];
